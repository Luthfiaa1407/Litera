    ...
    <div class="max-w-7xl mx-auto px-6 py-12">
                    ...
                    <div class="border-2 border-cyan-400 bg-white rounded-2xl shadow-md overflow-hidden">
                        <div class="h-48 bg-gray-200">
                            @if($borrow->book && $borrow->book->cover)
                                <img src="{{ asset('storage/'.$borrow->book->cover) }}" class="w-full h-full object-cover">
                            @endif
                        </div>
                        <div class="p-6">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                @empty
                <div class="col-span-4 text-center py-12 bg-cyan-50 border-2 border-dashed border-cyan-400 rounded-xl">
