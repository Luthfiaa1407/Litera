    ...
    <div class="flex min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center p-8"
            ...
            <div class="relative z-10 text-center text-white max-w-md">
                ...
                <h2 class="text-5xl md:text-6xl font-bold leading-tight mb-4">Selamat Datang<br>Kembali!</h2>
                <p class="text-lg opacity-90">Masuk ke akun Anda untuk melanjutkan perjalanan membaca</p>
            </div>
        </div>

        <!-- RIGHT PANEL - Form -->
        <div class="w-full lg:w-1/2 flex items-center justify-center p-4 md:p-8" style="background: #F8FAFC;">
            ...
            <div class="w-full max-w-md">
                ...
                <!-- Form Header -->
                <div class="mb-8">
                    <h3 class="text-3xl md:text-4xl font-bold" style="color: #1E1B4B;">Login</h3>
                    <p class="text-sm mt-2" style="color: #6B7280;">Selamat datang kembali. Silakan masuk ke akun Anda
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <div>
                        <label for="email" class="block text-sm font-semibold mb-2"
                            style="color: #1E1B4B;">Email</label>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <a href="{{ route('password.request') }}"
                            class="text-sm font-semibold hover:underline transition-colors" style="color: #06B6D4;">
                            Lupa Password?
                        </a>
                    </div>

                    <button type="submit"
                        class="w-full py-3 px-4 rounded-lg font-semibold text-white transition-all duration-300 transform hover:shadow-lg active:scale-95 flex items-center justify-center gap-2 text-base"
                ...
                <div class="text-center">
                    <p class="text-sm" style="color: #1E1B4B;">Belum punya akun?
                        <a href="{{ route('register') }}" class="font-semibold hover:underline transition-colors"
                            style="color: #06B6D4;">Daftar di sini</a>
                    </p>
                </div>
